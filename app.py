...
div[data-testid="stChatInput"] textarea:focus {{ box-shadow: none !important; outline: none !important; border: none !important; }}
div[data-testid="stChatInput"]:focus-within > div {{ border-color: {accent1} !important; box-shadow: 0 0 20px {input_glow} !important; }}
div[data-testid="stChatInput"] *:focus {{ outline: none !important; box-shadow: none !important; }}
...
# ---------------- RENDER ----------------
    ...
    # ── 1. DEBATE TRANSCRIPT (top, collapsed) ──────────────────────────────
    ...
    if debate:
        ...
        st.markdown(
            ...
            f"Movie Critique Model ({MODEL_CRITIC}) &nbsp;vs&nbsp; Advocate Model ({MODEL_ADVOCATE}) &nbsp;·&nbsp; 4 rounds</p>",
            unsafe_allow_html=True
        )
